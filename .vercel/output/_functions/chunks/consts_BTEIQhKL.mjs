...
import { w as generateCspDigest, s as spreadAttributes, u as unescapeHTML, b as renderTemplate, x as removeBase, i as isRemotePath, A as AstroError, y as UnknownContentCollectionError } from './entrypoint_Dm7pvM2q.mjs';
import { c as createComponent, b as VALID_INPUT_FORMATS } from './consts_BhKcTm52.mjs';
import 'clsx';
import 'piccolore';
...
class ImmutableDataStore {
  ...
  static async fromModule() {
    try {
      const data = await import('./_astro_data-layer-content_2nqAZNR-.mjs');
...
function createGetCollection({
  ...
  return async function getCollection(collection, filter) {
    ...
    if (store.hasCollection(collection)) {
      const { default: imageAssetMap } = await import('./content-assets_CwSuBHGc.mjs');
      const result = [];
...
export { getSite as a, getCollection as g };
